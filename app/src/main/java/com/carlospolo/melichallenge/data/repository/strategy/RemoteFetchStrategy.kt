...
/**
 * Implementation of [ProductFetchStrategy] that retrieves product data from a remote API.
 * This strategy is responsible for making network requests to fetch product lists and details.
 *
 * @property productsApiService The API service used to communicate with the remote data source.
 */
class RemoteFetchStrategy @Inject constructor(
    private val productsApiService: ProductsApiService
) : ProductFetchStrategy {

    /**
     * Fetches a list of products from the remote API based on a search query.
     *
    ...
    /**
     * Fetches the details of a specific product from the remote API.
     *
